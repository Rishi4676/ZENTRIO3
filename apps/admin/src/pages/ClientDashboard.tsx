                              ...
                              <button
                                onClick={() => {
                                  setSelectedInvoice({
                                    ...
                                    dueDate: p.date,
                                    items: [
                                      { description: p.projectTitle, qty: 1, rate: p.amount, amount: p.amount }
                                    ],
                                    taxRate: 18,
                                    discount: 0,
                                    status: 'PAID'
                                ...
                                className="p-1.5 rounded-lg bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:text-indigo-500 transition cursor-pointer"
