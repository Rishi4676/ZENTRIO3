        ...
        <div className="text-center mb-8">
          {matchedWorker ? (
            <div className="relative inline-block">
              <img
                src={(() => {
                  const id = matchedWorker.id.toLowerCase();
                  if (id === 'syedrashid_w1') return '/syed.jpg';
                  if (id === 'rishigesh_w2') return '/rishi.png';
                  if (id === 'pushparaj_w3') return 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=80';
                  return matchedWorker.avatar;
                })()}
