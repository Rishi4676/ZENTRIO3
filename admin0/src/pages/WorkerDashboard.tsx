      ...
      <div className="flex-grow flex flex-col md:flex-row max-w-7xl w-full mx-auto p-4 md:p-6 gap-6">
        ...
        <aside className="w-full md:w-64 shrink-0 flex flex-row md:flex-col gap-2 overflow-x-auto md:overflow-x-visible pb-3 md:pb-0 border-b md:border-b-0 md:border-r border-slate-200/50 dark:border-slate-900">
          <button
            ...
            className={`w-full text-left px-4 py-3 rounded-xl text-xs font-bold flex items-center space-x-3.5 transition shrink-0 ${
              activeTab === 'tasks'
          ...
          {activeTab === 'deliverables' && (
            <div className="space-y-6 text-left">
              ...
              <form onSubmit={handleUploadDeliverable} className="glass-card p-6 rounded-2xl border border-slate-200/50 dark:border-slate-850 shadow-sm max-w-xl space-y-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Resource File Link (HTTP/Cloud url)</label>
                  <input
                    type="text"
                    required
