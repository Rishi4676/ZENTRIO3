...
const { validateEmail, rateLimiter } = require('../middleware/security');
...
router.post('/', contactLimiter, async (req, res) => {
  try {
    ...
    try {
      const { notifyNewLeadInquiry } = require('../services/telegramService');
      await notifyNewLeadInquiry({ name, email, phone, service: subject, message });
    } catch (tgErr) {
